> [!CAUTION]
> **Superseded — archived 2026-08-27.** How feat/grammar-based-testing landed. Complete.
>
...
Related plans: [yaml-corpus.md](../reference/yaml-corpus-log.md), [grammar-based-conformance.md](../reference/conformance-lessons.md),
[json-grammar-spike.md](json-grammar-spike.md), [conformance-toolkit.md](../reference/conformance-toolkit.md).
...
Carried from [yaml-corpus.md](../reference/yaml-corpus-log.md), not blocking the merge:
...
The defect table for whoever fixes the parser is in [yaml-corpus.md](../reference/yaml-corpus-log.md) under "Picking this up
