> [!CAUTION]
> **Superseded — archived 2026-08-27.** The JSON proving ground the YAML corpus approach was replicated from. Complete.
>
...
See [conformance-toolkit.md](../reference/conformance-toolkit.md) for what the YAML toolkit is today and
