> [!CAUTION]
> **Superseded — archived 2026-08-27.** The corpus design. Its format decision and its deferred list are carried into stream 4.
>
...
Companion to [grammar-based-conformance.md](../reference/conformance-lessons.md), whose Stage 3 already called for caching labelled
