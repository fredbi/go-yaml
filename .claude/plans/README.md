> [!NOTE]
> Last revision: 2026-09-12 (`conformance-fixes` closed eleven defects -- clusters A, B and C, and both
...
| 2. 100% correctness | [`2-correctness.md`](2-correctness.md) | ⏳ decoder **372/372 scoreable**, `ToJSON` 272/274, oracle 393/393; **twenty-one open, all pinned** — 9 parser/scanner, 4 decoder, 3 `ToJSON`, 2 walk, 3 renderer; all three clusters closed 2026-09-12 and what is left has no cluster in it |
