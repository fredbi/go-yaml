> [!IMPORTANT]
> **Reference, not a plan.** What the grammar work taught: what held, what we got wrong, and what we did not see coming.
>
> The live plan is [4-test-suite-generator.md](../4-test-suite-generator.md). Record new decisions there, not here.
...
[yaml-corpus.md](yaml-corpus-log.md).
...
Related: [yaml-corpus.md](yaml-corpus-log.md) (the corpus and its ledger), [quirks.md](decoder-quirks.md) (parser
behaviour), [merge-grammar-branch.md](../archives/merge-grammar-branch.md) (how it landed).
