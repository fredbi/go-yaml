> [!IMPORTANT]
> **Reference, not a plan.** How `yamlgen`, `grammar` and the ledgers work, with the asymmetry caveat and the standing cautions.
>
...
Reference companion to [grammar-based-conformance.md](conformance-lessons.md) and
[coverage-guided-corpus.md](../archives/coverage-guided-corpus.md). Those two say what we are doing and why; this one says what exists,
