> [!IMPORTANT]
> **Reference, not a plan.** The 142 upstream issues open at the fork point, measured against their own reproducers.
>
> The live plan is [0-fork-posture.md](../0-fork-posture.md) and [2-correctness.md](../2-correctness.md). Record new decisions there, not here.
...
- Sibling documents: [`quirks.md`](decoder-quirks.md) for the decoder backlog, [`go-yaml-fork-roadmap.md`](../archives/go-yaml-fork-roadmap.md) for the plan.
...
5. 🔍 **#731**, **#753** — decoder and AST shape for empty documents. Related to the parser work already done;
   see [`quirks.md`](decoder-quirks.md).
